    ...
    public static class SampleDataInitializer
    {
        ...
        internal static void SeedData(ApplicationDbContext context)
        {
            ...
            catch (Exception ex)
            {
                ...
                // Поместить сюда точку останова, чтобы выяснить, в чем заключается проблема
                throw;
            }

            static void ProcessInsert<TEntity>(ApplicationDbContext context, DbSet<TEntity> table, List<TEntity> records)
